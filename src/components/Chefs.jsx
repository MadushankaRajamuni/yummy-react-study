...
import Chefs_img1 from "./assets/chefs/chefs-1.jpg";
import Chefs_img2 from "./assets/chefs/chefs-2.jpg";
import Chefs_img3 from "./assets/chefs/chefs-3.jpg";
function Chefs(){
    return(
            ...
            <div className="container" data-aos="fade-up">
                ...
                <div className="row gy-4">
                    ...
                    <div className="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up"
                        ...
                        <div className="chef-member">
                            <div className="member-img">
                                <img src={Chefs_img1} className="img-fluid" alt="" />
                    ...
                    <div className="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up"
                        ...
                        <div className="chef-member">
                            <div className="member-img">
                                <img src={Chefs_img2} className="img-fluid" alt=""/>
                                <div className="social">
                                    <a href=""><i className="bi bi-twitter"></i></a>
                                    <a href=""><i className="bi bi-facebook"></i></a>
                                    <a href=""><i className="bi bi-instagram"></i></a>
                    ...
                    <div className="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up"
                        ...
                        <div className="chef-member">
                            <div className="member-img">
                                <img src={Chefs_img3} className="img-fluid" alt=""/>
                                <div className="social">
                                    <a href=""><i className="bi bi-twitter"></i></a>
                                    <a href=""><i className="bi bi-facebook"></i></a>
                                    <a href=""><i className="bi bi-instagram"></i></a>
