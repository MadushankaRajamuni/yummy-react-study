...
import Img_reservation from "./assets/reservation.jpg"
function BookATable(){
    return(
        <section id="book-a-table" className="book-a-table">
            <div className="container" data-aos="fade-up">
                ...
                <div className="row g-0">
                    ...
                    <img src={Img_reservation} className="col-lg-4 reservation-img"  data-aos="zoom-out" data-aos-delay="200"/>
                    ...
                    <div className="col-lg-8 d-flex align-items-center reservation-form-bg">
                        <form action="forms/book-a-table.php" method="post" role="form" className="php-email-form" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <div className="text-center"><button type="submit" href="#">Book a Table</button></div>
                        </form>
